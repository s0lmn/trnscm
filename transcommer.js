const questions = [
  ...
  {
    question: "Who conducts the third round of E-LIST verification?",
  ...
  {
    question: "Which screening method is used when the IC is available?",
    options: ["Sphere", "FOCUS", "HOT", "ABBSS"],
    answer: "B"
  },
  {
  ...
  },
  {
    ...
    options: ["Red", "Amber & White", "Blue", "Black"],
    answer: "B"
  },
  {
  ...
  },
  {
    ...
    options: ["NSI", "Regular", "Mentor", "Buddy intake"],
    answer: "D"
  },
  {
  ...
  },
  {
    ...
    options: ["ECB", "SCD", "ESP", "EPT"],
    answer: "B"
  },
  {
    question: "Which acronym refers to the face-to-face safety assessment protocol?",
    options: ["SPICE", "E-LIST", "SALUTE", "AOJ"],
    answer: "C"
  },
  {
  ...
  },
  {
    ...
    options: ["ABBSS", "FOCUS", "LMS", "E-LIST"],
    answer: "A"
  },
  {
  ...
  {
    question: "What acronym is used for reporting casualties in ERT?",
    options: ["LMS", "EAA", "SPICE", "SSTF"],
    answer: "A"
  },
  {
    question: "Which MRT lines have 2 ESPs per platform?",
  ...
  {
    question: "What is the penalty for misuse of the ECB?",
  ...
  {
    question: "Which MRT station has a missing NFC tag at Platform A HW on TEL?",
    options: ["Springleaf", "Stevens", "Beauty World", "Woodlands"],
    answer: "A"
  },
  {
    question: "Which principle in LPS emphasizes officer and public safety?",
    options: ["Legality", "Proportionality", "Safety", "Authority"],
    answer: "C"
  },
  {
    question: "Which is NOT part of the CA symptom NBCBT?",
    options: ["Blood Agents", "Choking Agents", "Bone Agents", "Tear Agents"],
    answer: "C"
  },
  {
    question: "Which key information is required during screening?",
  ...
  },
  {
    ...
    options: ["Only the location", "Shift IC name", "Points missed and SB/OE station", "Photographs"],
    answer: "C"
  },
  {
  ...
  },
  {
    ...
    options: ["Dispose in bin", "Show to SM", "Swab area with alcohol wipes and plaster", "Mail to HQ"],
    answer: "C"
  },
  {
  ...
  },
  {
    ...
    options: ["Special Situational Task Force", "Special Station Tactics Force", "Special Station Tactical Force", "Station Security Task Force"],
    answer: "D"
  },
  {
    question: "When does SSTF respond?",
    options: ["After CBRE", "Before CBRE", "Only after TOR confirms", "Only during TASER deployment"],
    answer: "B"
  },
  {
  ...
  {
    question: "What is the purpose of Sabre 5000?",
  ...
  },
  {
    ...
    options: ["Team Officer Report", "Transport Operations Responder", "Transit Officer in Response", "Transport Observation Role"],
    answer: "B"
  },
  {
  ...
  {
    question: "When is a deviation message NOT required?",
    options: ["Missed point", "No SB/OE", "Minor incident", "Missed break"],
    answer: "D"
  },
  {
    question: "What is the minimum distance for taser safety?",
    options: ["1m", "2m", "3m", "5m"],
    answer: "C"
  },
  {
    question: "Who activates CBRE?",
    options: ["FPO", "TL", "OCC", "TOR"],
    answer: "D"
  },
  {
    question: "What does the MRT acronym EPT refer to?",
    options: ["Emergency Power Toggle", "Emergency Platform Telephone", "Electric Panel Transceiver", "Evacuation Point Tracker"],
    answer: "B"
  },
  {
    question: "Which category does 'spherical' fall under in screening?",
    options: ["Facial scan", "Manual scan", "Indirect recognition", "Situational profiling"],
    answer: "C"
  },
  {
    question: "How do you identify a TELI seal that has been tampered?",
    options: ["Turns blue", "Red seal broken", "Turns green", "Turns grey"],
    answer: "D"
  },
  {
    question: "What does the MRT mascot 'Stand Up Stacey' promote?",
    options: ["Yielding seats", "Walking slowly", "Standing in queues", "Reporting incidents"],
    answer: "A"
  },
  {
  ...
  {
    question: "Where is the fire extinguisher located on the MRT?",
    options: ["Beside door", "Under seat", "Near the ECB", "With SM"],
    answer: "C"
  },
  {
    question: "Which MRT station has 4 ESPs per platform?",
    options: ["DTL stations", "TEL stations", "NSL stations", "NSEWL stations"],
    answer: "D"
  },
  {
  ...
  {
    question: "Which MRT station is closest to Mandai Depot?",
    options: ["Woodlands", "Springleaf", "Mandai", "Khatib"],
    answer: "A"
  },
  {
    question: "What is the correct SALUTE format used for?",
    options: ["Taser deployment", "Reporting CA symptoms", "Reporting suspicious persons", "SSTF activation"],
    answer: "C"
  },
  {
  ...
  {
    question: "How do you handle probes embedded in red zones?",
    options: ["Pull them out", "Ask subject to remove", "Leave in and inform AB", "Radio TL"],
    answer: "C"
  },
  {
  ...
  },
  {
    ...
    options: ["Victim", "Violent subject", "Volunteer", "Verified suspect"],
    answer: "A"
  },
  {
    question: "Who must officers report to when missing a Bravo point?",
    options: ["Regular", "SSTF", "TL via MDT & Bravo chat", "OCC"],
    answer: "C"
  },
  {
  ...
  {
    question: "What section covers Robbery under the Penal Code?",
    options: ["s394", "s379", "s323", "s294"],
    answer: "A"
  },
  {
    question: "What tool helps officers assess chemical zones?",
    options: ["Green flare", "Red e-flare", "CA arrows", "SPICE scanner"],
    answer: "C"
  },
  {
    question: "What is the main use of BWC?",
    options: ["Night vision", "Evidence recording", "Location beacon", "Voice assistant"],
    answer: "B"
  },
  {
  ...
  {
    question: "Who should officers alert if they find a TELI breach?",
    options: ["TL", "SM", "TOR", "FPO"],
    answer: "C"
  },
  {
    question: "What triggers a CA Yellow alert?",
    options: ["Explosive", "Odor", "Confirmed CA", "Suspicious smell or symptoms"],
    answer: "D"
  },
  {
    question: "Which document logs all shift duty?",
    options: ["NP299", "Station Diary", "MDT", "SB record"],
    answer: "B"
  },
  {
  ...
  {
    question: "Which type of MRT station often has more than 3 exits and is considered high risk?",
    options: ["Red", "Yellow", "Orange", "Blue"],
    answer: "A"
  },
  {
    question: "What should you check for when inspecting a train?",
    options: ["PPEs, TELI, lost items", "Crowd", "Timings", "Speed"],
    answer: "A"
  },
  {
  ...
  },
  {
    ...
    "options": ["Newly installed", "No tampering", "Tampered", "Red station"],
    "answer": "C"
  },
  {
